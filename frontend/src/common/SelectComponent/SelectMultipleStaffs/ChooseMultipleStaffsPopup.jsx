...
function ChooseMultipleStaffsPopup(props) {
    ...
    const columns = [
        ...
        // },
        {
            ...
            render: (rowData) => (
                <>
                    {rowData.displayName &&
                        <p className='m-0'><strong>{`${rowData.displayName} - ${rowData.staffCode}`}</strong></p>}
    ...
    return (
        <GlobitsPopupV2
            noDialogContent
            popupId={"chooseChooseMultipleStaffsPopup"}
            open={open}
...
export default memo(observer(ChooseMultipleStaffsPopup)); 