...
function ReligionForm(props) {
    ...
    return (
        <CommonPopupV2
            ...
            noDialogContent
            title={(selectedRow?.id ? t("general.button.edit") : t("general.button.add")) + ' ' + t("Tôn giáo")}
...
export default memo(observer(ReligionForm));
