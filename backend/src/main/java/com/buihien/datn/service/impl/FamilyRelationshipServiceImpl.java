...
import com.buihien.datn.service.FamilyRelationshipService;
...
@Service
public class FamilyRelationshipServiceImpl extends GenericServiceImpl<FamilyRelationship, FamilyRelationshipDto, SearchDto> implements FamilyRelationshipService {
    @Override
    protected FamilyRelationshipDto convertToDto(FamilyRelationship entity) {
        return new FamilyRelationshipDto(entity);
    }

    @Override
    protected FamilyRelationship convertToEntity(FamilyRelationshipDto dto) {
    ...
    @Override
    public Page<FamilyRelationshipDto> pagingSearch(SearchDto dto) {
        ...
        StringBuilder sqlCount = new StringBuilder("SELECT COUNT(entity.id) FROM FamilyRelationship entity WHERE (1=1) ");
        StringBuilder sql = new StringBuilder("SELECT new com.buihien.datn.dto.FamilyRelationshipDto(entity) FROM FamilyRelationship entity WHERE (1=1) ");
        ...
        Query q = manager.createQuery(sql.toString(), FamilyRelationshipDto.class);
