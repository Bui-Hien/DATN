...
import com.buihien.datn.service.EthnicsService;
...
@Service
public class EthnicsServiceImpl extends GenericServiceImpl<Ethnics, EthnicsDto, SearchDto> implements EthnicsService {
    @Override
    protected EthnicsDto convertToDto(Ethnics entity) {
        return new EthnicsDto(entity);
    }

    @Override
    protected Ethnics convertToEntity(EthnicsDto dto) {
        Ethnics entity = null;
        if (dto.getId() != null) {
    ...
    @Override
    public Page<EthnicsDto> pagingSearch(SearchDto dto) {
        ...
        StringBuilder sqlCount = new StringBuilder("SELECT COUNT(entity.id) FROM Ethnics entity WHERE (1=1) ");
        StringBuilder sql = new StringBuilder("SELECT new com.buihien.datn.dto.EthnicsDto(entity) FROM Ethnics entity WHERE (1=1) ");
        ...
        Query q = manager.createQuery(sql.toString(), EthnicsDto.class);
