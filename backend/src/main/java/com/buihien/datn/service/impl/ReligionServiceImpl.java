...
import com.buihien.datn.service.ReligionService;
...
@Service
public class ReligionServiceImpl extends GenericServiceImpl<Religion, ReligionDto, SearchDto> implements ReligionService {
    @Override
    protected ReligionDto convertToDto(Religion entity) {
        return new ReligionDto(entity);
    }

    @Override
    protected Religion convertToEntity(ReligionDto dto) {
    ...
    @Override
    public Page<ReligionDto> pagingSearch(SearchDto dto) {
        ...
        StringBuilder sqlCount = new StringBuilder("SELECT COUNT(entity.id) FROM Religion entity WHERE (1=1) ");
        StringBuilder sql = new StringBuilder("SELECT new com.buihien.datn.dto.ReligionDto(entity) FROM Religion entity WHERE (1=1) ");
        ...
        Query q = manager.createQuery(sql.toString(), ReligionDto.class);
