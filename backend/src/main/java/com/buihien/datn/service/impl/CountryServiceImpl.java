...
import com.buihien.datn.service.CountryService;
...
@Service
public class CountryServiceImpl extends GenericServiceImpl<Country, CountryDto, SearchDto> implements CountryService {
    @Override
    ...
    @Override
    public Page<CountryDto> pagingSearch(SearchDto dto) {
        ...
        StringBuilder sqlCount = new StringBuilder("SELECT COUNT(entity.id) FROM Country entity WHERE (1=1) ");
        StringBuilder sql = new StringBuilder("SELECT new com.buihien.datn.dto.CountryDto(entity) FROM Country entity WHERE (1=1) ");
        ...
        Query q = manager.createQuery(sql.toString(), CountryDto.class);
