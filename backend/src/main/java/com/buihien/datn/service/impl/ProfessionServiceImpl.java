...
import com.buihien.datn.service.ProfessionService;
...
@Service
public class ProfessionServiceImpl extends GenericServiceImpl<Profession, ProfessionDto, SearchDto> implements ProfessionService {
    @Override
    protected ProfessionDto convertToDto(Profession entity) {
        return new ProfessionDto(entity);
    }

    @Override
    protected Profession convertToEntity(ProfessionDto dto) {
    ...
    @Override
    public Page<ProfessionDto> pagingSearch(SearchDto dto) {
        ...
        StringBuilder sqlCount = new StringBuilder("SELECT COUNT(entity.id) FROM Profession entity WHERE (1=1) ");
        StringBuilder sql = new StringBuilder("SELECT new com.buihien.datn.dto.ProfessionDto(entity) FROM Profession entity WHERE (1=1) ");
        ...
        Query q = manager.createQuery(sql.toString(), ProfessionDto.class);
